...
quelle proportion d'un segment est visible, étant donné un \oe{}il. Tout d'abord,
des critères de visibilités sont établis dans une première sous-section, suivi
de l'élaboration d'une procédure pour calculer la proportion du champ de vision
occupée par un segment donné.
...
adopté, l'oeil a une ouverture de $\pi/2$ radians.

Sans perte de généralité, $(x, y) = (0, 0)$; si ce n'est pas le cas, tous les
...
dans $\mathbb R^2$. La norme euclidienne d'un vecteur $v = (v_1, v_2)$ est notée
$\|v\| = \sqrt{v_1^2 + v_2^2}$. Au vu de la formule fondamentale liant le
...
$(0, 0)$ dont les directions et sens respectifs sont
